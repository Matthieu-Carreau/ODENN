...
On pourrait alors approfondir l'étude des différences de précision selon les différentes architectures de réseaux de neurones pour identifier lesquelles sont les plus pertinentes pour répondre à notre problème.

Il serait à présent intérressant d'utiliser l'approche présentée dans ce rapport pour tenter de résoudre directement l'équation de Landau-Lifshitz-Gilbert~\cite{EquationGilbert} sans projection, afin de constater si cela permet de retrouver les mêmes solutions que l'équation projetée ou non. 

On peut ensuite envisager d'étudier de façon similaire l'équation obtenue en ramplaçant le terme d'amortissement par un terme de nutation, ainsi que l'équation prenant à la fois en compte l'amortissement et la nutation.
