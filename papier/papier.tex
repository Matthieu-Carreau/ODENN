...
\begin{figure}
    ...
    \end{subfigure}
       \caption{Représentations graphiques de $M_x$ et  $M_y$ en fonction du temps par le réseau de neurones}
       \label{fig:résultats Mx, My from Mz}
\end{figure}


On trace également l'évolution de la norme de $\bm{\Tilde{M}}(t)$ en figure ~\ref{fig:norme de M}, et on constate qu'elle reste comprise entre 0.975 et 1. 

\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{norm over time.PNG}
    \caption{Norme de la magnétisation en fonction du temps}
    \label{fig:norme de M}
\end{figure}
