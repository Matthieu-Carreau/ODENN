...
\begin{abstract}
    ...
    La démarche consiste à décrire et mettre en {\oe}uvre des méthodes d'optimisation pour déterminer des solutions approchées à des équations différentielles, éventuellement non-linéaires, en fixant un modèle de solutions impliquant un réseau de neurones. 
