...
On trace également l'évolution de la norme de $\bm{\Tilde{M}}(t)$ dans la figure~\ref{fig:norme_de_M}, et on constate qu'elle reste comprise entre 0.975 et 1. 
...
\begin{thebibliography}{8}
    ...
    \bibitem{ANNforOPDEs}{\href{https://doi.org/10.1109/72.712178}{I. E. Lagaris, A. Likas and D. I. Fotiadis, IEEE Transactions on Neural Networks {\bf9} no. 5, 987-1000 (1998)}}
    ...
    \bibitem{FunctionApproximation}{\href{https://dl.acm.org/doi/10.5555/1466915.1466916#}{Z.Zainuddin and P.Ong, WSEAS Transactions on Mathematics Volume {\bf7} Issue 6, 333–338 (2008)}}
