...
Il serait à présent intéressant d'utiliser l'approche présentée dans ce rapport pour tenter de résoudre directement l'équation de Landau-Lifshitz-Gilbert~\cite{EquationGilbert} sans projection, afin de constater si cela permet de retrouver les mêmes solutions que l'équation projetée ou non. 
