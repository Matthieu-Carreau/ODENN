...
On définit une fonction d'erreur pour ces solutions potentielles, à partir de la valeur de la dérivée de $\Tilde{\Psi}$ aux $N$ points suivants : $\forall i \in\llbracket 1,N \rrbracket, x_i = \frac{i}{N-1} $
...
Lorsque $\mathcal{M}$ est inversible, on résoud le système linéaire 
en écrivant l'équation matricielle le représentant, soit
